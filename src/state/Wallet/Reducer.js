import { GET_USER_WALLET_REQUEST, DEPOSIT_MONEY_REQUEST, 
    TRANSFER_MONEY_REQUEST, GET_WALLET_TRANSACTION_REQUEST, 
    GET_WALLET_TRANSACTION_SUCCESS, GET_USER_WALLET_SUCCESS, 
    TRANSFER_MONEY_SUCCESS, DEPOSIT_MONEY_SUCCESS, 
    GET_USER_WALLET_FAILURE, DEPOSIT_MONEY_FAILURE, 
    TRANSFER_MONEY_FAILURE } from "./ActionType";
